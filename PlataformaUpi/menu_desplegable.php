<style>
    /* Diseño del estilo de Reservas Cercanas */
...
<div class="col-4 bg-light">
    <div class="card ">
        <div class="card-header text-center" style="background-color: #009933;color: white;">
            <h3 style="margin-top: 8px;">RESERVAS CERCANAS</h3>
        </div>
        <div class="card-body">
            <!-- Start while  -->
            <button class="accordion" style="background-color: #009933;color: white;">
                <div class="row">
                    <div class="col">
                        LISTADO<br> DE RESERVAS
                    </div>
