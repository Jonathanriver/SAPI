...
<?php
session_start();
include_once '../../Vista/HeaderProcessos.php';
...
include '../../Controladores/Transaccional/Misprocesos.php';
            ...
            <div class="col-8 text-center">
                ...
                <div class="row">
                    <div class="col text-left" style="margin:0px 150px 0px 15px;">
                        <h2 style="font-size:40px;" class="texto-titulo-perfil">MIS PROCESOS</h2>
                    </div>
                </div>
                <?php
                                    ...
                                    <div class="col-md-12 col-sm-8">
                                        <table class="table table-bordered" style="border-radius: 26px 0px 0px 26px !important;border: solid #fc7323 0.5px;">
                                            <thead style="background-color: #fc7323;color: white;">
                                                <tr class="text-center" style="text-align: center;">
                                                    ...
                                                    <th style="border: solid #fc7323 0.5px !important;" class="text-center" scope="col">Ver más</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php
                                                ...
                                                if (!empty($_POST)) {
                                                    ...
                                                    $query = "SELECT * FROM registro_full 
                                                    INNER JOIN `registro` ON `registro_full`.`registro_idRegistro`=`registro`.`idRegistro`
                                                    INNER JOIN usuarios ON registro_full.`usuarios_idUsuarios`=usuarios.`idUsuarios`
                                                    INNER JOIN tipo_registro ON registro_full.`tipo_registro_idTipo_Registro`= tipo_registro.`idTipo_Registro` 
                                                    WHERE Codigo_Proyecto like '%" . $aKeyword[0] . "%' OR idRegistro like '%" . $aKeyword[0] . "%' AND registro.usuarios_idUsuarios='$id_perfil'";
                                        ...
                                        <nav aria-label="Page navigation example">
                                            <div class="pagination">
                                                ...
                                                $query = "SELECT COUNT(*) FROM registro WHERE registro.usuarios_idUsuarios='$id_perfil' LIMIT 25";
                                        ...
                                        <div class="inline">
                                            ...
                                            <button class="btn btn" style="color:white; background-color:#fc7323;" onClick="go2Page();">Ir</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
